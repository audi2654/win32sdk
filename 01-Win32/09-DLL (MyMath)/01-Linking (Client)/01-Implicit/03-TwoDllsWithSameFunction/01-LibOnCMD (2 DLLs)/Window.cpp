#include <windows.h>
#include "MyMathOne.h"			// " " used to include headers files from Local Directory
#include "MyMathTwo.h"

//Link command to use: link.exe Window.obj user32.lib gdi32.lib kernel32.lib MyMathOne.lib OR MyMathTwo.lib /SUBSYSTEM:WINDOWS
