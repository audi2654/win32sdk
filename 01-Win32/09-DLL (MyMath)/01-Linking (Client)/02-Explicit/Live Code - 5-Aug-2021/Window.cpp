...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	typedef int (*PMAKESQUAREFUNCTION)(int);	//Function Pointer type
	PMAKESQUAREFUNCTION pMakeSquare = NULL;		//Function Pointer Variable
	...
	case WM_CREATE:
		...
		//We don't use TEXT("MakeSquare") because you can use this API over network too & those network socket APIs are still today also in ANSI format
		if (pMakeSquare == NULL)
		{
