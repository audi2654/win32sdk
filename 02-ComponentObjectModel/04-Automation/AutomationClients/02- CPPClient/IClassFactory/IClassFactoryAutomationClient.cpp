//Automation ClassFactory Flow Client CPP file
//Date:25th Oct 2021

//Commands to give for this file
//cl.exe /c /EHsc IClassFactoryAutomationClient.cpp
//link.exe IClassFactoryAutomationClient.obj user32.lib gdi32.lib kernel32.lib ole32.lib oleaut32.lib /SUBSYSTEM:WINDOWS /MACHINE:X64(optional)
...
{	
	...
	case WM_CREATE:
		...
		if (FAILED(hr))
		{
			MessageBox(NULL, TEXT("IMyMath Interface cannot be obtained"), TEXT("Error"), MB_OK);
			DestroyWindow(hwnd);
		}
		else
		{
			MessageBox(NULL, TEXT("IMyMath Interface obtained"), TEXT("From WM Create in Client"), MB_OK);
		}
