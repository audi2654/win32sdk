//Automation IDispatch Flow Client CPP Client
//Date:25th Oct 2021

//Commands to give for this file
//cl.exe /c /EHsc IDispatchAutomationCppClient.cpp
//link.exe IDispatchAutomationCppClient.obj user32.lib gdi32.lib kernel32.lib ole32.lib oleaut32.lib /SUBSYSTEM:WINDOWS	/MACHINE:x64(optional)
...
{	
	...
	case WM_CREATE:
		...
		if (FAILED(hr))
		{
			MessageBox(NULL, TEXT("IDispatch Interface cannot be obtained"), TEXT("Error"), MB_OK);
			DestroyWindow(hwnd);
		}
		else
		{
			MessageBox(NULL, TEXT("IDispatch Interface obtained"), TEXT("From WM Create in Client"), MB_OK);
		}
