//Aggregation Flow BARE CLIENT CPP file
//Date:27th Sept 2021

//Commands to give for this file
//cl.exe /c /EHsc ClientOfAggregationComponentWithRegFile.cpp
//link.exe ClientOfAggregationComponentWithRegFile.obj user32.lib gdi32.lib kernel32.lib ole32.lib oleaut32.lib /SUBSYSTEM:WINDOWS	/MACHINE:x64(optional)
...
{	
	...
	case WM_CREATE:
		...
		if (FAILED(hr))
		{
			MessageBox(NULL, TEXT("ISum Interface cannot be obtained"), TEXT("WM_CREATE Error"), MB_OK);
			DestroyWindow(hwnd);
		}
		else
		{
