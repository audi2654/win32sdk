//ClassFactory LockServer() Extra Assignment Server File 
...
BOOL WINAPI DllMain(HINSTANCE hDll, DWORD dwReason, LPVOID Reserved)
{
	...
	case DLL_PROCESS_ATTACH:
		...
		MessageBox(NULL, str, TEXT("In DLL_PROCESS_ATTACH"), MB_OK);
		break;

	case DLL_PROCESS_DETACH:
		wsprintf(str, TEXT("glNumberOfActiveComponents = %d & glNumberOfServerLocks = %d"), glNumberOfActiveComponents, glNumberOfServerLocks);
		MessageBox(NULL, str, TEXT("In DLL_PROCESS_DETACH"), MB_OK);
		break;
	}
	return(TRUE);
}
...
HRESULT CSumSubtractClassFactory::CreateInstance(IUnknown* pUnkOuter, REFIID riid, void** ppv)
{
	...
	//code
	wsprintf(str, TEXT("glNumberOfActiveComponents = %d & glNumberOfServerLocks = %d"), glNumberOfActiveComponents, glNumberOfServerLocks);
	MessageBox(NULL, str, TEXT("In CreateInstance() at Start"), MB_OK);
	if (pUnkOuter != NULL)
	{
	...
	wsprintf(str, TEXT("glNumberOfActiveComponents = %d & glNumberOfServerLocks = %d"), glNumberOfActiveComponents, glNumberOfServerLocks);
	MessageBox(NULL, str, TEXT("In CreateInstance() at End"), MB_OK);
	return(hr);
}
...
HRESULT CSumSubtractClassFactory::LockServer(BOOL fLock)
{
	...
	wsprintf(str, TEXT("glNumberOfActiveComponents = %d & glNumberOfServerLocks = %d"), glNumberOfActiveComponents, glNumberOfServerLocks);
	MessageBox(NULL, str, TEXT("In LockServer() at End"), MB_OK);
	return(S_OK);
}
...
extern "C" HRESULT __stdcall DllCanUnloadNow(void)
{
	//code
	wsprintf(str, TEXT("glNumberOfActiveComponents = %d & glNumberOfServerLocks = %d"), glNumberOfActiveComponents, glNumberOfServerLocks);
	MessageBox(NULL, str, TEXT("In DllCanUnloadNow() at Start"), MB_OK);
